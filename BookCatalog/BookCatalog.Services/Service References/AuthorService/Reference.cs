...
namespace BookCatalog.Services.AuthorService {
    ...
    public interface IAuthorService {
        ...
        BookCatalog.Services.AuthorService.GetAuthorsResponse GetAuthors(BookCatalog.Services.AuthorService.GetAuthorsRequest request);
        
        // CODEGEN: Generating message contract since the operation has multiple return values.
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IAuthorService/GetAuthors", ReplyAction="http://tempuri.org/IAuthorService/GetAuthorsResponse")]
        System.Threading.Tasks.Task<BookCatalog.Services.AuthorService.GetAuthorsResponse> GetAuthorsAsync(BookCatalog.Services.AuthorService.GetAuthorsRequest request);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IAuthorServiceChannel : BookCatalog.Services.AuthorService.IAuthorService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class AuthorServiceClient : System.ServiceModel.ClientBase<BookCatalog.Services.AuthorService.IAuthorService>, BookCatalog.Services.AuthorService.IAuthorService {
        
        public AuthorServiceClient()
        {
            Infrastructure.Logging.Concrete.InfoLogger.Log("AuthorServiceClient", "Constructor");
        }
        ...
        ~AuthorServiceClient()
        {
            Infrastructure.Logging.Concrete.InfoLogger.Log("AuthorServiceClient", "Destructor");
        }
        ...
        BookCatalog.Services.AuthorService.GetAuthorsResponse BookCatalog.Services.AuthorService.IAuthorService.GetAuthors(BookCatalog.Services.AuthorService.GetAuthorsRequest request) {
        ...
        public System.Collections.Generic.List<BookCatalog.Components.ViewModels.AuthorViewModel> GetAuthors(System.Collections.Generic.Dictionary<string, System.ComponentModel.ListSortDirection> sorts, System.Collections.Generic.List<BookCatalog.Infrastructure.Filtration.CustomFilter> filters, int take, int skip, out int total) {
            BookCatalog.Services.AuthorService.GetAuthorsRequest inValue = new BookCatalog.Services.AuthorService.GetAuthorsRequest();
            inValue.sorts = sorts;
            inValue.filters = filters;
            inValue.take = take;
            inValue.skip = skip;
            BookCatalog.Services.AuthorService.GetAuthorsResponse retVal = ((BookCatalog.Services.AuthorService.IAuthorService)(this)).GetAuthors(inValue);
            total = retVal.total;
            return retVal.GetAuthorsResult;
        }
        
        public System.Threading.Tasks.Task<BookCatalog.Services.AuthorService.GetAuthorsResponse> GetAuthorsAsync(BookCatalog.Services.AuthorService.GetAuthorsRequest request) {
