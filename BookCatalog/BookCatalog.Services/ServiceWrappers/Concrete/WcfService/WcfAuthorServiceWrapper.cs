...
namespace BookCatalog.Services.ServiceWrappers.Concrete.WcfService
{
    ...
    public class WcfAuthorServiceWrapper : IAuthorServiceWrapper
    {
        ...
        /// </summary>
        private IAuthorService DomainModel { get; set; }

        public WcfAuthorServiceWrapper(IAuthorService domainModel)
        {
            Infrastructure.Logging.Concrete.InfoLogger.Log("WcfAuthorServiceWrapper", "Constructor");
            this.DomainModel = domainModel;
        }

        ~WcfAuthorServiceWrapper()
        {
            Infrastructure.Logging.Concrete.InfoLogger.Log("WcfAuthorServiceWrapper", "Destructor");
        }
