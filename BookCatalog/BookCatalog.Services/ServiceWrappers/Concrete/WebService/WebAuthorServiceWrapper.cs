...
// </copyright>
//-----------------------------------------------------------------------
namespace BookCatalog.Services.ServiceWrappers.Concrete.WebService
{
    #region Using
    ...
    public class WebAuthorServiceWrapper : IAuthorServiceWrapper
    {
        ...
        /// </summary>
        private AuthorWebService.AuthorWebServiceSoap DomainModel { get; set; }

        public WebAuthorServiceWrapper(AuthorWebService.AuthorWebServiceSoap domainModel)
        {
            Infrastructure.Logging.Concrete.InfoLogger.Log("WebAuthorServiceWrapper", "Constructor");
            this.DomainModel = domainModel;
        }

        ~WebAuthorServiceWrapper()
        {
            Infrastructure.Logging.Concrete.InfoLogger.Log("WebAuthorServiceWrapper", "Destructor");
        }
