...
namespace BookCatalog.Services.ServiceWrappers.Concrete.WebService
{
    ...
    public class WebBookServiceWrapper : IBookServiceWrapper
    {
        ...
        /// </summary>
        private BookWebService.BookWebServiceSoap DomainModel { get; set; }
        ...
        ~WebBookServiceWrapper()
        {
            Infrastructure.Logging.Concrete.InfoLogger.Log("WebBookServiceWrapper", "Destructor");
        }
